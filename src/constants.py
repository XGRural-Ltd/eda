# Centralized store ids used across pages
STORE_MAIN = "main-df-store"
STORE_PROCESSED = "processed-df-store"
STORE_PCA = "pca-df-store"
...
STORE_SCALER = "scaler-store"
STORE_PCA_FEATURES = "pca-features-store"